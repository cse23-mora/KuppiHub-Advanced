    ...
    <div className="min-h-screen py-12 px-4 bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <div>
            <Link href="/faculty" className="px-4 py-2 rounded-full bg-white border border-blue-200 shadow-sm text-blue-700 hover:bg-blue-600 hover:text-white transition">Browse Modules</Link>
          </div>
        </div>
        ...
        {modules.length === 0 ? (
          ...
          >
            ...
            <Link href="/faculty" className="inline-block mt-4 px-6 py-2 rounded-full bg-blue-600 text-white hover:bg-blue-700 transition">
              Browse Modules
            </Link>
          </motion.div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {modules.map((m, i) => (
              <motion.div
                ...
                className="bg-white rounded-2xl shadow-md p-6 border border-blue-50 cursor-pointer hover:shadow-xl hover:scale-105 transition-all duration-300 group"
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="w-14 h-14 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-xl flex items-center justify-center group-hover:from-blue-200 group-hover:to-indigo-200 transition-all">
                ...
                <h2 className="text-xl font-semibold text-gray-800 mb-2 group-hover:text-blue-600 transition-colors">{m.module.code} - {m.module.name}</h2>
